  ...
  return (
    <>
      ...
      <div className="blogWrap generalContainer">
        <div className="blog-item1" role="button" onClick={details}>
          <img src={img1} alt="" />
          <div className="blog-item1-info">
            ...
            <p className="blog-item-txt">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum
              ratione neque reiciendis sapiente quaerat eius distinctio?
            </p>
          </div>
        </div>
        <div className="blog-item" role="button" onClick={details}>
          <img src={img2} alt="" />
        ...
        <div className="blog-item" role="button" onClick={details}>
          ...
          <div className="blog-item-info">
            ...
            <p className="blog-item-ttl">
              Must i have a skill to apply for Internship?
            </p>
            <p className="blog-item-txt">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum
              ratione neque reiciendis sapiente quaerat eius distinctio?
